 ...
 */
@Slf4j
public class JavaSecureKeyPairToBytesConversionUtils {
    ...
    @NotNull
    public static PrivateKey privatekey(@NotNull byte[] rowPrivateKey) {
     ...
     */
    @NotNull
    public static PublicKey publickey(@NotNull byte[] rowPublicKey) {
        Security.addProvider(new BouncyCastleProvider());
        try {
    ...
    public static Sm2KeyPair convertKeyPairToSm2KeyPair(@NotNull KeyPair keyPair) {
        byte[] publicKeyBytes = JavaSecureKeyPairToBytesConversionUtils.publicKeyToBytes(keyPair.getPublic());
        byte[] privateKeyToBytes = JavaSecureKeyPairToBytesConversionUtils.privateKeyToBytes(keyPair.getPrivate());
     ...
     */
    @NotNull
    public static PublicKey bytesToPublicKey(@NotNull byte[] bytes) {
        try {
     ...
     */
    @NotNull
    public static PrivateKey bytesToPrivateKey(@NotNull byte[] bytes) {
        try {
            KeyFactory keyFactory = KeyFactory.getInstance("EC");
