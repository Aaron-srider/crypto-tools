<template>
    <div class="hello">
        <h1>About</h1>
        <el-card>
            <template #header>generate sm2 key</template>
            ...
            <el-input
                type="textarea"
                readonly
                v-model="generatedPrivate"
            ></el-input>
        </el-card>
        <el-card>
            <template #header>generate cert</template>
            base64 pub key:
            <el-input
                v-model="pubKeyInput"
                @input="onUserInputPubKeyInput"
            ></el-input>
            base64 cert data:
            <el-input
                type="textarea"
        ...
        <el-card>
            <template #header>extract cert</template>
            base64 cert data:
            <el-input
                v-model="inputCertForExtraction"
                @input="userInputForCertExtraction"
            ></el-input>
            base64 pub key:
            <el-input
                type="textarea"
        ...
        <el-card>
            ...
            <div class="flex">
                <el-button size="" @click="onInput">do</el-button>
                select type:
                <el-select v-model="userInputMode" @change="inputModeChange">
                    <el-option
            ...
            <el-input
                type="textarea"
                autosize
                v-model="formByteArray"
            ></el-input>
            char array(c)
            <el-input
                type="textarea"
                autosize
                v-model="formCharArray"
            ></el-input>
